...
function parallax_one_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'parallax_one_logos_content', array(
		'sanitize_callback' => 'parallax_one_sanitize_text',
		'default' => json_encode(array( array("image_url" => parallax_get_file('/images/companies/7.png') ,"link" => "#" ),array("image_url" => parallax_get_file('/images/companies/9.png') ,"link" => "#" ),array("image_url" => parallax_get_file('/images/companies/8.png') ,"link" => "#" ) ))
